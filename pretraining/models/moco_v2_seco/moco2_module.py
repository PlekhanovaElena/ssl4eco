...
class MocoV2(LightningModule):
    ...
    def __init__(self, arch, moco_dim, moco_k, bands, emb_spaces=3, *args, **kwargs):
        ...
        self.encoder_q.conv1 = torch.nn.Conv2d(self.hparams.n_channels,64,kernel_size=(7,7),stride=(2,2),padding=(3,3),bias=False)
        self.encoder_k.conv1 = torch.nn.Conv2d(self.hparams.n_channels,64,kernel_size=(7,7),stride=(2,2),padding=(3,3),bias=False)
